    ...
    <div class="row my-5 ">
        <div class="col-md-5">
            <div class="card card-outline card-navy rounded-0 shadow">
                <div class="card-header">
                    <h4 class="card-title">Informatii Contact</h4>
                </div>
                <div class="card-body rounded-0">
                    <dl>
                        ...
                        <dt class="text-muted"><i class="fa fa-map-marked-alt"></i> Locatie</dt>
                        <dd class="pl-4"><?= $_settings->info('address') ?></dd>
                        <dt class="text-muted"><i class="fa fa-clock"></i> Program</dt>
                        <dd class="pl-4"><?= $_settings->info('clinic_schedule') ?></dd>
                        <dt class="text-muted"><i class="fa fa-paw"></i> Programari</dt>
        ...
        <div class="col-md-7">
            <div class="card rounded-0 card-outline card-navy shadow" >
                <div class="card-body rounded-0">
                    <h2 class="text-center">Scrie-ne un mesaj</h2>
                    ...
                    <form action="" id="message-form">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <small class="px-3 text-muted">Nume / Prenume</small>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                <small class="text-muted">Text mesaj</small>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12 text-center">
                                <button class="btn btn-primary rounded-pill col-5">Trimite mesaj</button>
                            </div>
                        </div>
                    </form>
                </div>
    ...
    $(function(){
        $('#message-form').submit(function(e){
            ...
            $.ajax({
				...
				error:err=>{
					console.log(err)
					alert_toast("A aparut o eroare",'error');
					end_loader();
				},
                success:function(resp){
                    if(resp.status == 'success'){
                        ...
                        el.addClass("alert-danger")
                        el.text("A aparut o eroare din motive necunoscute.")
                        _this.prepend(el)
                    }
                    el.show('slow')
