...
<div class="content py-5">
    <h3 class="">Serviciile noastre</h3>
<hr>
                ...
                <div class="list-group">
                    <div class="list-group-item list-group-item-action">
                        <div class="custom-control custom-checkbox">
                          ...
                          <label for="category_all" class="custom-control-label">Toate</label>
                        </div>
                    </div>
                    <?php 
                    ...
                    <div class="list-group-item list-group-item-action">
                        <div class="custom-control custom-checkbox">
                            <input class="custom-control-input category-item" type="checkbox" id="category_<?= $row['id'] ?>" value="<?= $row['id'] ?>" 
                            <?= $cid=='all' || in_array($row['id'],explode(',',$cid)) ? "checked" : "" ?>>
