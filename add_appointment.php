...
<div class="container-fluid">
    <form action="" id="appointment-form">
        ...
        <dl>
            <dt class="text-muted">Orar Programări</dt>
        ...
        <div class="row">
            <div class="col-md-6">
                <fieldset>
                    <legend class="text-muted">Informații despre proprietar</legend>
                    <div class="form-group">
                        <label for="owner_name" class="control-label">Nume Prenume</label>
                        <input type="text" name="owner_name" id="owner_name" class="form-control form-control-border" placeholder="Ioan Popescu" value ="<?php echo isset($owner_name) ? $owner_name : '' ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="contact" class="control-label">Numar telefon #</label>
                        <input type="text" name="contact" id="contact" class="form-control form-control-border" placeholder="07xxxxxxxx" value ="<?php echo isset($contact) ? $contact : '' ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="email" class="control-label">Email</label>
                        <input type="email" name="email" id="email" class="form-control form-control-border" placeholder="numeprenume@exemplu.com" value ="<?php echo isset($email) ? $email : '' ?>" required>
                    </div>
                    <div class="form-group">
                        <label for="address" class="control-label">Adresa</label>
                        <textarea type="email" name="address" id="address" class="form-control form-control-sm rounded-0" rows="3" placeholder="Str. Cutare, Nr. Cutare, Mun. xxxx, Judet xxxx, Tara xxxxx" required><?php echo isset($address) ? $address : '' ?></textarea>
                    </div>
                </fieldset>
            </div>
            <div class="col-md-6">
                <fieldset>
                    <legend class="text-muted">Informatii despre animalul de companie</legend>
                    <div class="form-group">
                        <label for="category_id" class="control-label">Tipul animalului de companie</label>
                    ...
                    <div class="form-group">
                        <label for="breed" class="control-label">Rasa</label>
                    ...
                    <div class="form-group">
                        <label for="age" class="control-label">Varsta</label>
                ...
                <div class="form-group">
                    <label for="service_id" class="control-label">Serviciu(i) dorit(e)</label>
                    <?php 
...
<script>
    ...
    $(function(){
        $('#uni_modal').on('shown.bs.modal',function(){
            $('#category_id').select2({
                placeholder:"Va rog selectati tipul animalului de companie aici.",
                width:'100%',
                dropdownParent:$('#uni_modal')
            })
            $('#service_id').select2({
                placeholder:"Va rog selectati tipul de serviciu dorit.",
                width:'100%',
                dropdownParent:$('#uni_modal')
            })
        })
        $('#category_id').change(function(){
            ...
            $('#service_id').select2({
                placeholder:"Va rog selectati aici tipul de serviciu dorit.",
                width:'100%',
                dropdownParent:$('#uni_modal')
            })
            ...
            $.ajax({
                ...
                success:function(resp){
                    ...
                    end_loader();
                        ...
                        el.addClass("alert-danger")
                        el.text("Eroare din cauze necunoscute.")
                        _this.prepend(el)
                    }
                    el.show('slow')
