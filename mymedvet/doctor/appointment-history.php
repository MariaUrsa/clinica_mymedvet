...
<html lang="en">
	<head>
		<title>Doctor Veterinar | Istoric Programare</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Doctor Veterinar | Istoric Programare</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
									...
									<table class="table table-hover" id="sample-table-1">
										<thead>
											<tr>
												...
												<th>Programare Dată / Timp </th>
												<th>Programare Creare Dată </th>
												<th>Status Curent</th>
												<th>Acțiune</th>
										...
										<tbody>
<?php
$sql=mysqli_query($con,"select users.fullName as fname,appointment.*  from appointment join users on users.id=appointment.userId where appointment.vetdocId='".$_SESSION['id']."'");
$cnt=1;
...
{
	echo "Anulat de Pacient";
}

if(($row['userStatus']==1) && ($row['vetdocStatus']==0))  
{
	echo "Anulat de dumneavostră";
}
