...
<html lang="en">
	<head>
		<title>Doctor Veterinar | Schimbă Parola</title>
...
{
alert("Câmpul Parolei Curentă este goal!");
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Doctor Veterinar | Schimbă Parola</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
						...
						<div class="container-fluid container-fullw bg-white">
							...
							<input type="password" name="cpass" class="form-control"  placeholder="Introduceți Parola Nouă">
														</div>
														<div class="form-group">
															<label for="exampleInputPassword1">
																Parolă Nouă
															</label>
					<input type="password" name="npass" class="form-control"  placeholder="Parolă Nouă">
														</div>
...
<div class="form-group">
									...
									<input type="password" name="cfpass" class="form-control"  placeholder="Confirmă Parola">
														</div>
