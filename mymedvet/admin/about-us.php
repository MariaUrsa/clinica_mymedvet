...
$pagedes=$con->real_escape_string($_POST['pagedes']);
    ...
    echo '<script>alert("Despre Noi a fost actualizat.")</script>';
  }
  else
    {
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin  | Actualizați conținutul Despre Noi</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin </span>
									...
									<li class="active">
										<span>Actualizați conținutul Despre Noi</span>
									</li>
								</ol>
							</div>
						</section>
