...
Căutare după Nume Pacient/ CNP Proprietar
</label>
...
<a href="view-patient.php?viewid=<?php echo $row['ID'];?>" class="btn btn-primary btn-xs" target="_blank">Vizualizează</a>
...
$cnt=$cnt+1;
  ...
  <tr>
    <td colspan="8"> Nu s-a găsit nicio înregistrare a acestei căutări.</td>
