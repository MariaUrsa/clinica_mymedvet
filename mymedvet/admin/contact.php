...
$email=$_POST['email'];
 $mobnum=$_POST['mobnum'];
    ...
    echo '<script>alert("Contactează-ne a fost actualizat.")</script>';
  }
  else
    {
...
<html lang="en">
	<head>
		<title>Admin | Contactează-ne </title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin  | Actualizare Conținut Contactează-ne</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin </span>
									...
									<li class="active">
										<span>Actualizare Conținut Contactează-ne </span>
									</li>
								</ol>
							</div>
						</section>
