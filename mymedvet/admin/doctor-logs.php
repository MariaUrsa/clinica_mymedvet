...
<html lang="en">
	<head>
		<title>Admin | Sesiune Logări Doctori Veterinari</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin  | Sesiune Logări Doctori Veterinari</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin </span>
									...
									<li class="active">
										<span>Sesiune Logări Doctori Veterinari</span>
									</li>
								</ol>
							</div>
						</section>
								...
								<?php echo htmlentities($_SESSION['msg']="");?></p>	
									<table class="table table-hover" id="sample-table-1">
										<thead>
											<tr>
												<th class="center">#</th>
												<th class="hidden-xs">Utilizator ID</th>
												<th>Username</th>
												<th>Utilizator IP</th>
												<th>Timp Logare </th>
												<th>Timp Delogare </th>
										...
										<tbody>
<?php
$sql=mysqli_query($con,"select * from vetdoclog ");
$cnt=1;
