...
<html lang="en">
	<head>
		<title>Admin | Adaugă Doctor Veterinar</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Admin | Adaugă Doctor Veterinar</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
									...
									<li class="active">
										<span>Adaugă Doctor Veterinar</span>
									</li>
								</ol>
							</div>
						</section>
										...
										<div class="col-lg-8 col-md-12">
											<div class="panel panel-white">
												<div class="panel-heading">
													<h5 class="panel-title">Adaugă Doctor Veterinar</h5>
												</div>
...
<div class="form-group">
					...
					<input type="text" name="docname" class="form-control"  placeholder="Introduceți Nume Doctor Veterinar" required="true">
														</div>
...
<div class="form-group">
					...
					<textarea name="clinicaddress" class="form-control"  placeholder="Introduceți Doctor Clinic Address" required="true"></textarea>
														</div>
<div class="form-group">
															<label for="fess">
															Taxă Consultație
															</label>
					<input type="text" name="docfees" class="form-control"  placeholder="Introduceți Taxă Consultație" required="true">
														</div>
...
<div class="form-group">
					...
					<input type="text" name="doccontact" class="form-control"  placeholder="Introduceți Număr Telefon Doctor Veterinar" required="true">
														</div>
...
<input type="email" id="docemail" name="docemail" class="form-control"  placeholder="Introduceți E-mail Doctor Veterinar" required="true" onBlur="checkemailAvailability()">
