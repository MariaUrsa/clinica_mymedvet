								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle">Administrare Utilizatori</h2>
...
{
?>
											Total Utilizatori:<?php echo htmlentities($num_rows);  } ?>		
												</a>
											</p>
										</div>
									</div>
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle">Administrare Doctori Veterinari</h2>
										
											<p class="cl-effect-1">
												<a href="manage-doctors.php">
												<?php $result1 = mysqli_query($con,"SELECT * FROM vetdoc ");
$num_rows1 = mysqli_num_rows($result1);
{
?>
											Total Doctori Veterinari:<?php echo htmlentities($num_rows1);  } ?>		
												</a>
								...
								<div class="col-sm-4">
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<h2 class="StepTitle"> Programări</h2>
...
{
?>
											Total Programări:<?php echo htmlentities($num_rows2);  } ?>	
												</a>
												</a>
											</p>
										</div>
