...
{
$_SESSION['errmsg']="Nume de utilizator sau parolă nevalide.";
					...
					<form class="form-login" method="post">
						<fieldset>
							...
							<div class="form-group form-actions">
								<span class="input-icon">
									<input type="password" class="form-control password" name="password" placeholder="Parolă"><i class="fa fa-lock"></i>
									 </span>
							</div>
							...
							<a href="../../index.php">Pagină Principală</a>
