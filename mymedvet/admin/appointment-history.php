...
<html lang="en">
	<head>
		<title>Pacienți | Istoric Programare</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle">Pacienți | Istoric Programare</h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Pacienți </span>
						...
						<div class="container-fluid container-fullw bg-white">
								...
								<?php echo htmlentities($_SESSION['msg']="");?></p>	
									<table class="table table-hover" id="sample-table-1">
										...
										<tbody>
<?php
$sql=mysqli_query($con,"select vetdoc.vetdocName as docname,users.fullName as pname,appointment.*  from appointment join vetdoc on vetdoc.id=appointment.vetdocId join users on users.id=appointment.userId ");
$cnt=1;
...
echo "Încă nu s-a luat nicio măsură";
	 } else {
